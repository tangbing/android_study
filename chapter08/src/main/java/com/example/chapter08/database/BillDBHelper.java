...
public class BillDBHelper extends SQLiteOpenHelper {
    private static  final String DB_NAME = "billInfo.db";
    // 账单信息表
    ...
    public long save(BillInfo info) {
       ...
       long result = mWDB.insert(TABLE_BILL_INFO, null, values );
       return result;
    }

    @SuppressLint("Range")
    public  List<BillInfo> queryBill(String yearMonth) {
